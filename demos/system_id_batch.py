...
def sys_id_demo():
    ...
    composite_body = sim.init_composite_object(
                                    ...
                                    rotation=rotation,
                                    offset=offset)
    action_1 = sim.sample_action(composite_body)
    action_2 = sim.sample_action(composite_body)
    world_1 = sim.make_world(composite_body, action_1)
    world_2 = sim.make_world(composite_body, action_2)

    run_world_batch([world_1, world_2], run_time=5)
    print(world_1.get_p())
    print(world_2.get_p())
